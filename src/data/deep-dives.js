      ...
      boxes: [
        {
          ...
          detail: {
            ...
            sections: [
              ...
              { heading: 'Explore', commands: [
                '# VMIs backing a hosted cluster’s workers\noc get vmi -n clusters-<hosted-cluster>',
                '# The DataVolume + PVC each VM root disk is imported into\noc get dv,pvc -n clusters-<hosted-cluster>',
              ] },
            ],
          },
        },
          ...
          detail: {
            ...
            sections: [
              { heading: 'Note', bullets: [
                ...
                'Writes the kubelet config, pull secret, and the guest cluster CA the node trusts — all minted a cluster up by the Control Plane Operator (as Secrets in the HCP namespace) and handed down through the Ignition Server.',
              ] },
