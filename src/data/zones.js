    ...
    nodes: [
      {
        ...
        typePrefix: 'Client',
        badges: [
          { label: 'HTTPS :443', color: 'var(--k-slate)' },
          { label: 'TLS 1.3', color: 'var(--k-slate)' },
        ],
      },
    ],
  },
            ...
            nodes: [
              {
                ...
                typePrefix: 'Pod',
                badges: [{ label: 'HostedCluster CR', color: 'var(--k-teal)' }],
              },
              {
                id: 'cluster-version-operator',
                title: 'Cluster Version Operator',
                typePrefix: 'Pod',
                badges: [{ label: 'ClusterVersion CR', color: 'var(--k-teal)' }],
              },
              {
                id: 'guest-api-server',
                ...
                typePrefix: 'Pod',
                badges: [
                  { label: ':6443', color: 'var(--k-teal)' },
                  { label: 'gRPC', color: 'var(--k-teal)' },
                ],
              },
              {
                ...
                typePrefix: 'Pod',
                badges: [{ label: 'OAuth2', color: 'var(--k-teal)' }],
              },
              {
                id: 'guest-controller-manager',
                title: 'Guest Controller Manager',
                typePrefix: 'Pod',
                badges: [{ label: 'Controllers', color: 'var(--k-teal)' }],
              },
              {
                id: 'guest-kube-scheduler',
                title: 'Guest Scheduler',
                typePrefix: 'Pod',
                badges: [{ label: 'Bindings', color: 'var(--k-teal)' }],
              },
              {
                id: 'etcd-static-pod',
                title: 'Etcd',
                ...
                badges: [
                  { label: 'State Store', color: 'var(--k-teal)' },
                  { label: 'Raft', color: 'var(--k-teal)' },
                ],
              },
              {
                ...
                typePrefix: 'Pod',
                badges: [
                  { label: 'HAProxy', color: 'var(--k-teal)' },
                  { label: 'Route CR', color: 'var(--k-teal)' },
                ],
              },
              {
                ...
                typePrefix: 'Pod',
                badges: [{ label: 'Northbound DB', color: 'var(--k-teal)' }],
              },
              {
                id: 'cloud-controller-manager',
                title: 'Cloud Controller Manager',
                typePrefix: 'Pod',
                badges: [{ label: 'Cloud API', color: 'var(--k-teal)' }],
              },
              {
                id: 'konnectivity-server',
                title: 'Konnectivity Server',
                typePrefix: 'Pod',
                badges: [{ label: 'Tunnel :8091', color: 'var(--k-teal)' }],
              },
              {
                id: 'ignition-server',
                title: 'Ignition Server',
                typePrefix: 'Pod',
                badges: [{ label: 'Bootstrap', color: 'var(--k-teal)' }],
              },
              {
                id: 'guest-coredns',
                title: 'Guest CoreDNS',
                typePrefix: 'Pod',
                badges: [{ label: 'DNS :53', color: 'var(--k-teal)' }],
              },
              {
                id: 'cluster-monitoring',
                title: 'Cluster Monitoring',
                typePrefix: 'Pod',
                badges: [{ label: 'Prometheus', color: 'var(--k-teal)' }],
              },
            ],
          },
        ],
        ...
        nodes: [
          {
            ...
            title: 'Kubelet',
            typePrefix: 'systemd',
            badges: [{ label: 'CRI client', color: 'var(--k-sky)' }],
          },
          {
            id: 'crio-host',
            title: 'CRI-O',
          ...
          },
          {
            ...
            typePrefix: 'systemd',
            badges: [
              { label: 'br-int', color: 'var(--k-sky)' },
              { label: 'OpenFlow', color: 'var(--k-sky)' },
            ],
          },
          {
            id: 'ovn-node-host',
            title: 'OVN-K8s Node',
            typePrefix: 'Pod',
            badges: [{ label: 'CNI', color: 'var(--k-sky)' }],
          },
        ],
        zones: [
          {
            ...
            nodes: [
              {
                ...
                typePrefix: 'Pod',
                badges: [
                  { label: 'QEMU/KVM', color: 'var(--k-amber)' },
                  { label: 'tap0', color: 'var(--k-amber)' },
                ],
              },
            ],
            zones: [
                ...
                nodes: [
                  {
                    ...
                    title: 'Kubelet (Guest)',
                    typePrefix: 'systemd',
                    badges: [{ label: 'CRI client', color: 'var(--k-orange)' }],
                  },
                  {
                    id: 'crio-guest',
                    title: 'CRI-O (Guest)',
                    typePrefix: 'systemd',
                    badges: [
                      { label: 'OCI', color: 'var(--k-orange)' },
                      { label: 'CNI', color: 'var(--k-orange)' },
                    ],
                  },
                  {
                    id: 'ovs-guest',
                    ...
                    typePrefix: 'systemd',
                    badges: [
                      { label: 'br-int', color: 'var(--k-orange)' },
                      { label: 'virtio-net', color: 'var(--k-orange)' },
                    ],
                  },
                  {
                    id: 'ovn-node-guest',
                    ...
                    typePrefix: 'Pod',
                    badges: [{ label: 'CNI', color: 'var(--k-orange)' }],
                  },
                  {
                    id: 'konnectivity-agent',
                    title: 'Konnectivity Agent',
                    typePrefix: 'Pod',
                    badges: [{ label: 'Tunnel', color: 'var(--k-orange)' }],
                  },
                  {
                    id: 'coredns-node',
                    title: 'CoreDNS Node',
                  ...
                  },
                  {
                    ...
                    typePrefix: 'Pod',
                    badges: [
                      { label: 'e-commerce-prod', color: 'var(--k-orange)' },
                      { label: ':8080', color: 'var(--k-orange)' },
                    ],
                  },
                  {
