...
// Small line glyphs for the action chip that leads a revealed description. 12×12,
// stroke = currentColor so each inherits its action accent. Kept terse to read
// cleanly at chip size, in the spirit of the interaction-row icons.
function KindGlyph({ name }) {
  ...
  switch (name) {
    ...
    case 'route': // route — a node fanning out to two paths
      return <svg {...c}><circle cx="3.5" cy="8" r="1.3" /><path d="M4.8 8H8l3-3.2h2" /><path d="M8 8l3 3.2h2" /><path d="M11.5 3.3 13.2 4.8 11.5 6.3" /><path d="M11.5 9.7 13.2 11.2 11.5 12.7" /></svg>
